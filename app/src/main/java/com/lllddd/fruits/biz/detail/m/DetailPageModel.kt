...
package com.lllddd.fruits.biz.detail.m
...
/**
 * author: lllddd
 * created on: 2024/5/27 14:05
 * description:详情页Model
 */
class DetailPageModel {
    fun modifyFruit(params: Map<String, String>, callback: OkHttpCallback) {
